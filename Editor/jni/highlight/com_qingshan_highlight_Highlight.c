...
#include "com_qingshan_highlight_Highlight.h"
...
JNIEXPORT jbyteArray JNICALL Java_com_qingshan_highlight_Highlight_read_1file(JNIEnv *env, jclass cls, jstring file)
{
	char *buffer;
	const char *path;
	jboolean iscopy;
 ...
 */
JNIEXPORT jintArray JNICALL Java_com_qingshan_highlight_Highlight_jni_1parse(JNIEnv *env, jclass cls, jstring text, jstring syntaxfile)
{
	int textfilesize;
